      ...
      <div class="footer-top-content">
        ...
        <div class="logo-contacts">
          ...
          <div class="contact-info">
            <div class="phone">+7 (831) 2-000-000</div>
            <div class="address">Нижний Новгород, ул. Ларина, 23</div>
          </div>
        </div>
        <div class="socials">
...
.background-overlay {
  width: 100%;
  height: 100%;
  background-color: rgba(28, 25, 25, 0.82);
